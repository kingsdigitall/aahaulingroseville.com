      ...
      <div className="mx-auto flex h-full max-w-7xl flex-col items-center justify-center gap-10 text-center lg:flex-row">
        <div className="lg:w-[40%]">
          <h2 className="text-3xl font-bold text-gray-800">
            Trusted Junk Removal & Hauling Services in Roseville
          </h2>
          <p className="mt-4 text-gray-600">
            Need reliable junk removal solutions? Our team offers fast,
            professional, and affordable junk removal and hauling services.
            Whether it’s residential cleanouts, commercial debris removal, or
            construction site cleanup, we’ve got you covered. Call now for
        ...
        <div className="mt-8 flex flex-col justify-center gap-6 lg:flex-row ">
          ...
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg bg-white p-6 shadow-md ">
            ...
            <h3 className="mt-4 text-lg font-bold text-gray-800">
              Affordable Junk Removal Solutions
            </h3>
            <p className="mt-2 text-gray-600">
              We offer cost-effective junk removal services tailored to your
              budget, ensuring high-quality workmanship at competitive prices.
            </p>
          </div>
          {/* Various Services */}
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg border border-main bg-white p-6 shadow-md">
            ...
            <p className="mt-2 text-gray-600">
              From minor cleanouts to major hauling projects, we provide a full
              range of services to meet all your needs.
            </p>
          </div>
          {/* Timely Service */}
          <div className="flex w-full max-w-sm flex-col items-center rounded-lg bg-white p-6 shadow-md">
            ...
            <p className="mt-2 text-gray-600">
              ...
              keeping your property clean and clutter-free without delays.
            </p>
          </div>
        </div>
      </div>
